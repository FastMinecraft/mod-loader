...
package dev.fastmc.loader.xz.index;
...
import dev.fastmc.loader.xz.common.DecoderUtil;
import dev.fastmc.loader.xz.XZIOException;
import dev.fastmc.loader.xz.CorruptedInputException;

public class IndexHash extends IndexBase {
    private dev.fastmc.loader.xz.check.Check hash;

    public IndexHash() {
        super(new CorruptedInputException());

        try {
            hash = new dev.fastmc.loader.xz.check.SHA256();
        } catch (java.security.NoSuchAlgorithmException e) {
            hash = new dev.fastmc.loader.xz.check.CRC32();
        }
    }
